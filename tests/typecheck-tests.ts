...
type CreateTuple<L, V = string> =
	...
	L extends number ? N.IsNegative<L> extends 1 ? // Length must always be non-negative
			never :
		// base case
		L extends 0 ? [] :
		// recursion depth check
		// typescript has a limit.
		N.Lower<L, 50> extends 1 ? [V, ...CreateTuple<N.Sub<L, 1>, V>] :
		never :
		never;
...
(function describe(_ = 'Result') {
	(function describe(_ = 'andThen') {
		...
		(function it(
			_ =
				'Infers error type when returning disjoint types (native scalar types)',
		) {
		...
		(function it(
			_ =
				'Infers new ok type when returning both Ok and Err (different from initial)',
		) {
	...
	(function describe(_ = 'orElse') {
		...
		(function it(_ = 'allows specifying the E and T types explicitly') {
			...
			const result: Expectation = ok<'yo', number>('yo').orElse<string>(
				(val) => {
					return err('yo');
				},
			);
	...
	(function describe(_ = 'combineWithAllErrors') {
		...
		(function describe(_ = 'inference on large tuples') {
			(function it(
				...
				type Expectation = Result<
					CreateTuple<6, string>,
					CreateTuple<6, number>
				>;
			...
			(function it(
				...
				type Expectation = Result<
					CreateTuple<15, string>,
					CreateTuple<15, number>
				>;
			...
			(function it(
				...
				type Expectation = Result<
					CreateTuple<30, string>,
					CreateTuple<30, number>
				>;
			...
			(function it(
				...
				type Expectation = Result<
					CreateTuple<49, string>,
					CreateTuple<49, number>
				>;
...
(function describe(_ = 'ResultAsync') {
	(function describe(_ = 'andThen') {
		...
		(function describe(_ = 'when returning Result types') {
			...
			(function it(
				_ =
					'Infers new ok type when returning both Ok and Err (same as initial)',
			) {
		...
		(function describe(
			...
			(function it(
				_ =
					'allows for explicitly specifying the Ok and Err types when inference fails',
			) {
	...
	(function describe(_ = 'orElse') {
		...
		(function it(
			_ =
				'allows specifying ok and err return types when mixing Result and ResultAsync in returns ',
		) {
			type Expectation = ResultAsync<number, number | string>;
